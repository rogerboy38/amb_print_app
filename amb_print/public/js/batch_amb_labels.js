// amb_print — Batch AMB internal documents (doctype_js; additive to amb_w_spc batch_amb.js).
// Generates the Registro de Envasado + Carta de Instrucciones de Secado, attaches + downloads.
frappe.ui.form.on('Batch AMB', {
    refresh(frm) {
        ...
        frm.add_custom_button(__('Registro de Envasado'), () => gen('Barrel Scan Sheet', 'Registro-Envasado'), __('Labels'));
        frm.add_custom_button(__('Carta de Instrucciones'), () => gen('Carta de Instrucciones Secado', 'Carta-Instrucciones'), __('Labels'));
    }
});
