...
################################################################################
# push_to_git_plus.sh - Enhanced Git Push Script for App AMB Print v6.0.0
#
...
REPO_URL="${GIT_REMOTE_URL:-https://github.com/rogerboy38/amb_print_app.git}"
APP_VERSION="v13.5.2"
...
show_header() {
    echo -e "${BLUE}"
    echo "╔══════════════════════════════════════════════════════════════╗"
    echo "║                   App AMB Print Git Helper                    ║"
    echo "║                        Version $SCRIPT_VERSION                         ║"
    echo "╚══════════════════════════════════════════════════════════════╝"
    echo -e "${NC}"
    echo "Repository: https://github.com/rogerboy38/app_amb_print"
...
simple_push() {
    ...
    echo -e "View repo: ${BLUE}https://github.com/rogerboy38/app_amb_print${NC}"
    echo "----------------------------------------"
}
